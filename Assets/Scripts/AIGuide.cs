...
public class AIGuide : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Added because apiKey is necessary even for confederate
    ...
    void Update()
    {
        ...
        // Accessing guidance functions is only necessary for the player - the confederate should remain ignorant of this
        if (!m_ConfederateHandlerScript.confederateVersion)
        {
